...
if __name__ == '__main__':
    ...
    for i, file_name in enumerate(dirs):
        ...
        for p in range(len(labels_rects)):
            ...
            img = cv2.circle(img,bb1[0], 6, red, -1)
            # cv2.putText(img, text=str(p), org=(bb1[0]), fontFace=3, fontScale=0.5, color=(0,0,255))
            ...
            # print(bb1)
                ...
                img = cv2.circle(img,bb2[0], 6, green, -1)
